  ...
  <body>
    ...
    <div id="wrapper">
      ...
      <div id="page-wrapper">      	
          <div class="col-lg-12" >
          	<div class="row">
          		<h1>Cuadrillas <small>Lista de cuadrillas</small></h1>
	          	<ol class="breadcrumb">
	              <li><a href="../../"><i class="fa fa-globe"></i> Inicio</a></li>
	              <li class="active"><i class="fa fa-desktop"></i> Datos basicos</li>
	              <li class="active"><i class="fa fa-table"></i> Cuadrillas</li>
	            </ol>	
          	</div>   
            <!-- <div class="row">
		    ...
		    <div class="row">
		    	<div class="table-responsive">	
	              <table id="example" class="table table-hover table-striped table-condensed tablesorter" cellspacing="0" width="100%">
	                <thead>
	                  <tr align="center">
	                    <th>ID Cuadrilla <i class="fa fa-sort"></i></th>
	                ...
	                <tbody>
	                  <?php
							...
							foreach ($result as $fila) { ?>
								<tr>									
									<td><?php echo str_pad($fila['cod_cuadrillas'], 5, "0", STR_PAD_LEFT); ?></td>
          ...
          <!-- Modal -->
			<div class="modal fade" id="ModelCuadrillas" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
