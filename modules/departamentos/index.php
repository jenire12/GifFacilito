  ...
  <body>
    ...
    <div id="wrapper">
      ...
      <div id="page-wrapper">      	
          <div class="col-lg-12" >
          	<div class="row">
          		<h1>Departamentos <small>Lista de departamentos</small></h1>
	          	<ol class="breadcrumb">
	              <li><a href="../../"><i class="fa fa-globe"></i> Inicio</a></li>
	              <li class="active"><i class="fa fa-desktop"></i> Datos basicos</li>
	              <li class="active"><i class="fa fa-table"></i> Departamentos</li>
	            </ol>	
          	</div>   
            <!-- <div class="row">
            	<div class="col-lg-2 col-lg-offset-10">
	            	<a class="btn btn-primary pull-right" href="./lesiones_agregar.php" data-toggle="modal" data-target="#ModelLesiones"> <span class="glyphicon glyphicon-plus-sign"></span> Agregar cargos </a>
	            </div>	
            </div> -->
            <br />
            <div class="row">    	 
		    ...
		    <div class="row">
		    	<div class="table-responsive">	
	              <table id="example" class="table table-hover table-striped table-condensed tablesorter" cellspacing="0" width="100%">
	                <thead>
	                  <tr align="center">
	                    <th>ID Departamento <i class="fa fa-sort"></i></th>
	                    <th>Nombre del Departamento <i class="fa fa-sort"></i></th>
	                    <th>Pertenencia <i class="fa fa-sort"></i></th>
	                ...
	                <tbody>
	                  <?php
	                  		$sql = "
									...
									FROM
										tsca_departamentos t1
										JOIN tsca_departamentos t2 ON t1.dpto_padre = t2.cod_departamento
									ORDER BY descripcion
	                  				";
							$result = ejecutarPDO("cnx_siceac", $sql); 
							foreach ($result as $fila) { ?>
								<tr>									
									<td><?php echo str_pad($fila['cod_departamento'], 5, "0", STR_PAD_LEFT); ?></td>
									<td title="<?php echo $fila['descripcion']; ?>"><?php echo substr($fila['descripcion'],0,40); ?></td>
									<td title="<?php echo $fila['padre']; ?>"><?php echo substr($fila['padre'],0,40); ?></td>
									<!-- <td>																				
          ...
          <!-- Modal -->
			<div class="modal fade" id="ModelDepartamentos" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
