  ...
  <body>
    ...
    <div id="wrapper">
      ...
      <div id="page-wrapper">      	
		    ...
		    <div class="row">
		    	<div class="table-responsive">	
	              <table id="example" class="table table-hover table-striped table-condensed tablesorter" cellspacing="0" width="100%">
	                <thead>
	                  <tr align="center">
	                    <th>ID Cargo <i class="fa fa-sort"></i></th>
	                ...
	                <tbody>
	                  <?php
							...
							foreach ($result as $fila) { ?>
								<tr>									
									<td><?php echo str_pad($fila['id_cargo'], 5, "0", STR_PAD_LEFT); ?></td>
          ...
          <!-- Modal -->
			<div class="modal fade" id="ModelCargos" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
